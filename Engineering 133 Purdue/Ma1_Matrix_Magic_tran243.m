...
fprintf ('After doing step 8.e, the value of the center of H is %i.\n',H(3,3))
fprintf ('After doing step 8.e, the value in the upper left of H is %i and the value in the upper right of H is %i.\n',H(1,1),H(1,5))
fprintf ('After doing step 8.e, the value in the lower left of H is %i and the value in the lower right of H is %i.\n',H(5,1),H(5,5))
